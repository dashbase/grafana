...
func NewDashbaseExecutor(datasource *models.DataSource) (tsdb.TsdbQueryEndpoint, error) {
...
func init() {
	...
	tsdb.RegisterTsdbQueryEndpoint("dashbase-datasource", NewDashbaseExecutor)
}
func (e *DashbaseExecutor) Query(ctx context.Context, dsInfo *models.DataSource, tsdbQuery *tsdb.TsdbQuery) (*tsdb.Response, error) {
	...
	req, err := e.createRequest(dsInfo, tsdbQuery.Queries[0], tsdbQuery.TimeRange.GetFromAsMsEpoch(), tsdbQuery.TimeRange.GetToAsMsEpoch())
	if err != nil {
		return nil, err
	}

	if len(tsdbQuery.Queries) > 1 {
...
func (e *DashbaseExecutor) createRequest(dsInfo *models.DataSource, query *tsdb.Query, timeFrom int64, timeTo int64) (*http.Request, error) {
